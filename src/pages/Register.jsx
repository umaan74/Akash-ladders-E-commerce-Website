    ...
    <div className="min-h-[85vh] flex items-center justify-center px-4 py-12 text-slate-900 dark:text-slate-100">
      <div className="max-w-xl w-full space-y-6">
        ...
        <div className="text-center space-y-2">
          ...
          <h1 className="text-3xl font-black text-slate-900 dark:text-white tracking-tight">Create Customer Account</h1>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full bg-slate-50 dark:bg-slate-950 border border-slate-300 dark:border-slate-700 rounded-xl pl-10 pr-4 py-2.5 text-sm text-slate-900 dark:text-white focus:outline-none focus:border-amber-500"
                />
              </div>
            </div>
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                <input
                  ...
                  onChange={handleChange}
                  placeholder="Mumbai"
                  className="w-full bg-slate-50 dark:bg-slate-950 border border-slate-300 dark:border-slate-700 rounded-xl px-4 py-2.5 text-sm text-slate-900 dark:text-white focus:outline-none focus:border-amber-500"
                />
              </div>

              <div>
                <label className="block text-xs font-semibold text-slate-700 dark:text-slate-300 mb-1">PIN Code</label>
                <input
                  type="text"
                  name="pincode"
                  required
