...
import { 
  ShieldCheck, Award, Building2, CheckCircle2, 
  Layers, Scale, ArrowRight, Truck, Wrench 
} from 'lucide-react';
...
const About = () => {
  return (
    <div className="space-y-16 pb-16">
      ...
      {/* Hero Banner */}
      <section className="bg-slate-950 border-b border-slate-800 py-16 text-center relative overflow-hidden">
        <div className="max-w-4xl mx-auto px-4 space-y-4 relative z-10">
          <span className="text-xs uppercase tracking-widest font-bold text-amber-500">Established 1998</span>
          <h1 className="text-4xl sm:text-5xl font-black text-white">About Akash Ladders</h1>
          ...
          <div className="lg:col-span-6 space-y-6">
            ...
            <div className="grid grid-cols-2 gap-4 pt-2">
              <div className="bg-slate-900 p-4 rounded-2xl border border-slate-800 space-y-1">
                <div className="text-amber-400 font-black text-xl">ISO 9001:2015</div>
                <div className="text-white font-bold text-xs">Quality System</div>
              </div>
              <div className="bg-slate-900 p-4 rounded-2xl border border-slate-800 space-y-1">
                <div className="text-amber-400 font-black text-xl">EN131 Standard</div>
                <div className="text-white font-bold text-xs">European Certified</div>
              </div>
            </div>
          </div>
      ...
      <section className="bg-slate-900 border-y border-slate-800 py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12">
          ...
          <div className="text-center max-w-2xl mx-auto">
            ...
            <h2 className="text-3xl font-black text-white mt-1">What Sets Akash Ladders Apart</h2>
            <p className="text-slate-400 text-sm mt-1">Every rung, rivet, and hinge is designed for maximum structural safety.</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="bg-slate-950 border border-slate-800 p-6 rounded-2xl space-y-4">
              ...
              <h3 className="text-lg font-bold text-white">100% Safety Certified</h3>
            ...
            <div className="bg-slate-950 border border-slate-800 p-6 rounded-2xl space-y-4">
              ...
              <h3 className="text-lg font-bold text-white">Aircraft Grade Alloy</h3>
              <p className="text-slate-400 text-xs leading-relaxed">
            ...
            <div className="bg-slate-950 border border-slate-800 p-6 rounded-2xl space-y-4">
              ...
              <h3 className="text-lg font-bold text-white">Tailor-Made Fabrication</h3>
              <p className="text-slate-400 text-xs leading-relaxed">
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <div className="bg-slate-900 border border-slate-800 p-10 rounded-3xl space-y-6 max-w-3xl mx-auto">
          <h2 className="text-3xl font-black text-white">Ready to Upgrade Your Access Safety?</h2>
          <p className="text-slate-400 text-sm">Browse our full catalogue or talk directly with our sales team for bulk quotes.</p>
          <div className="flex justify-center gap-4">
            ...
            <Link
              to="/contact"
              className="px-8 py-3.5 bg-slate-800 hover:bg-slate-700 text-white font-bold rounded-xl text-sm border border-slate-700 transition-all"
            >
              Contact Sales Head
            </Link>
          </div>
