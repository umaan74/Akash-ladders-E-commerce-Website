...
import { 
  ...
  Send, CheckCircle2, User, Building2, ShieldCheck 
} from 'lucide-react';
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 space-y-12">
      ...
      <div className="bg-slate-900 border border-slate-800 p-6 sm:p-8 rounded-3xl space-y-3 relative overflow-hidden">
        <div className="relative z-10">
          ...
          <h1 className="text-3xl sm:text-4xl font-black text-white">Contact Akash Ladders Sales & Engineering</h1>
          <p className="text-slate-400 text-sm max-w-2xl">
            Have questions about load specs, custom ladder dimensions, or corporate bulk pricing? Contact Sales Head <strong className="text-amber-400">Imran Rauf Khan</strong> today.
          </p>
        </div>
      </div>
          ...
          {submitted ? (
            <div className="bg-emerald-500/10 border border-emerald-500/30 p-6 rounded-2xl text-center space-y-3">
              ...
              <p className="text-slate-300 text-xs">
                Thank you, <strong className="text-white">{formData.name}</strong>. Sales Head Imran Rauf Khan (+91 8898133393) will get back to you within 2 hours.
              </p>
            </div>
          ) : (
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <select
                    ...
                    onChange={handleChange}
                    className="w-full bg-slate-950 border border-slate-700 text-white rounded-xl px-3 py-2.5 text-sm focus:outline-none focus:border-amber-500"
                  >
              ...
              <div>
                ...
                <textarea
                  ...
                  className="w-full bg-slate-950 border border-slate-700 rounded-xl px-3 py-2.5 text-sm text-white focus:outline-none focus:border-amber-500 resize-none"
                />
              </div>
          ...
          <div className="bg-slate-900 border border-slate-800 p-6 rounded-3xl space-y-5">
            ...
            <div className="space-y-4 text-xs">
              ...
              <div className="bg-slate-950 p-4 rounded-2xl border border-slate-800 flex items-start gap-3">
                ...
                <div>
                  <span className="block font-bold text-white text-sm">Imran Rauf Khan</span>
                  <span className="text-slate-400 text-xs">Head of Sales & Technical Procurement</span>
                </div>
              </div>
              ...
              <div className="bg-slate-950 p-4 rounded-2xl border border-slate-800 flex items-start gap-3">
                ...
                <div>
                  <span className="block font-bold text-white">Phone & Mobile:</span>
                  <a href="tel:8898133393" className="text-amber-400 hover:underline font-bold text-sm">
                    +91 8898133393
                  </a>
                </div>
              </div>
              ...
              <div className="bg-slate-950 p-4 rounded-2xl border border-slate-800 flex items-start gap-3">
                ...
                <div>
                  <span className="block font-bold text-white">WhatsApp Hotline:</span>
                  <a 
              ...
              <div className="bg-slate-950 p-4 rounded-2xl border border-slate-800 flex items-start gap-3">
                ...
                <div>
                  <span className="block font-bold text-white">Email Addresses:</span>
                  <a href="mailto:info@akashladders.com" className="text-slate-300 hover:text-white block">
                    info@akashladders.com
                  </a>
                  <a href="mailto:sales@akashladders.com" className="text-slate-300 hover:text-white block">
              ...
              <div className="bg-slate-950 p-4 rounded-2xl border border-slate-800 flex items-start gap-3">
                ...
                <div>
                  <span className="block font-bold text-white">Factory & Head Office Address:</span>
              ...
              <div className="bg-slate-950 p-4 rounded-2xl border border-slate-800 flex items-start gap-3">
                ...
                <div>
                  ...
                  <span className="block text-slate-500 text-[10px]">Sunday Closed (WhatsApp active)</span>
                </div>
              </div>
      ...
      <div className="bg-slate-900 border border-slate-800 rounded-3xl p-6 space-y-4">
        ...
        <div className="w-full h-72 rounded-2xl overflow-hidden bg-slate-950 border border-slate-800 relative flex items-center justify-center text-center p-6">
          {/* Embedded Google Map */}
          <iframe
            ...
            className="w-full h-full border-0 filter opacity-80 grayscale contrast-125"
            allowFullScreen=""
            loading="lazy"
