  ...
  if (wishlist.length === 0) {
    return (
      <div className="max-w-4xl mx-auto px-4 py-16 text-center space-y-6">
        <div className="w-20 h-20 bg-slate-900 border border-slate-800 rounded-full flex items-center justify-center text-rose-500 mx-auto">
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 space-y-8">
      ...
      <div className="border-b border-slate-800 pb-6 flex items-center justify-between">
        <div>
          ...
          <h1 className="text-3xl font-black text-white">Your Saved Wishlist ({wishlist.length})</h1>
        </div>
      </div>
          ...
          <div key={product.id} className="relative flex flex-col justify-between">
            ...
            <div className="mt-2 flex gap-2">
              ...
              <button
                ...
                className="p-2 bg-slate-900 border border-slate-800 text-slate-400 hover:text-rose-400 rounded-xl transition-colors"
